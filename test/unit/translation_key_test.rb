...
class Tr8n::TranslationKeyTest < Tr8n::BaseTest
  ...
  test "gender based translations in English" do
    ...
    assert_equal "Dear Tom", key.translate(@default_language, :user => [@user, :method_with_param, "Tom"])
    ...
    assert_equal ["Tr8n::DataToken", "Tr8n::TransformToken"], key.tokens.collect{|t| t.class.name}
    ...
    assert_equal ["Tr8n::TransformToken"], key.tokens.collect{|t| t.class.name}
  ...
  test "number based translations in English" do
    ...
    assert_equal ["Tr8n::DataToken", "Tr8n::HiddenToken"], key.tokens.collect{|t| t.class.name}
    ...
    assert_equal ["Tr8n::DataToken", "Tr8n::DataToken", "Tr8n::HiddenToken"], key.tokens.collect{|t| t.class.name}
    ...
    assert_equal ["Tr8n::DataToken", "Tr8n::DataToken", "Tr8n::TransformToken"], key.tokens.collect{|t| t.class.name}
  ...
  test "decoration tokens" do
    ...
    assert_equal ["Tr8n::DecorationToken"], key.tokens.collect{|t| t.class.name}
    ...
    assert_equal ["Tr8n::DecorationToken"], key.tokens.collect{|t| t.class.name}
    assert_equal "<a href='www.google.com'>click here</a>", key.translate(@default_language, :link => ["www.google.com"])
  ...
  test "nested tokens" do
    ...
    assert_equal ["Tr8n::MethodToken", "Tr8n::DecorationToken"], key.tokens.collect{|t| t.class.name}
    assert_equal "Hello <b>Michael</b>", key.translate(@default_language, :user => @user)
    ...
    assert_equal ["Tr8n::DataToken", "Tr8n::TransformToken", "Tr8n::DecorationToken"], key.tokens.collect{|t| t.class.name}
    assert_equal "Dear Michael, you have <b>5 messages</b> in your inbox", key.translate(@default_language, :user => @user, :count => 5)
  end  
#  
#  test "words" do
