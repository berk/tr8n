...
class Tr8n::TokenTest < Tr8n::BaseTest
  ...
  test "data tokens" do
    tokens = Tr8n::DataToken.parse("Hello {user}, you have {count} messages in your inbox")
    ...
    tokens = Tr8n::DataToken.parse("Hello {user:gender}, you have {count:number} messages in your inbox")
    assert_equal ["{user:gender}", "{count:number}"], tokens.collect{|t| t.full_name}
    assert_equal ["{user}", "{count}"], tokens.collect{|t| t.sanitized_name}
    assert_equal ["user", "count"], tokens.collect{|t| t.name}
    
    tokens = Tr8n::DataToken.parse("Hello {user:gender}, you have {count} messages in your inbox")
    assert_equal ["{user:gender}", "{count}"], tokens.collect{|t| t.full_name}
    assert_equal ["{user}", "{count}"], tokens.collect{|t| t.sanitized_name}
    assert_equal ["user", "count"], tokens.collect{|t| t.name}
    
    tokens = Tr8n::DataToken.parse("Hello {user:gender}, you have {_count} messages in your inbox")
  ...
  test "hidden tokens" do
    tokens = Tr8n::HiddenToken.parse("{user} updated {_his_her} profile")
    ...
    tokens = Tr8n::HiddenToken.parse("{user} has {count} {_posted__items} in {_his_her} inbox")
    ...
    tokens = Tr8n::HiddenToken.parse("{user:gender} has {count:number} {_posted__items:number} in {_his_her} inbox")
    assert_equal ["{_his_her}"], tokens.collect{|t| t.full_name}
    assert_equal ["{_his_her}"], tokens.collect{|t| t.sanitized_name}
    assert_equal ["_his_her"], tokens.collect{|t| t.name}
    assert_equal ["his/her"], tokens.collect{|t| t.humanized_name}
  ...
  test "method tokens" do
    tokens = Tr8n::MethodToken.parse("{user} {user.name} updated {_his_her} profile")
    ...
    tokens = Tr8n::MethodToken.parse("{user.first_name} [link: {user.last_name}] updated {_his_her} profile")
    ...
    tokens = Tr8n::MethodToken.parse("{user.first_name:gender} [link: {user.last_name:gender}] updated {_his_her} profile")
  ...
  test "transform tokens" do
    tokens = Tr8n::TransformToken.parse("{user.name} updated {user|his,her} profile")
    assert_equal ["{user|his,her}"], tokens.collect{|t| t.full_name}
    assert_equal ["{user}"], tokens.collect{|t| t.sanitized_name}
    assert_equal ["user"], tokens.collect{|t| t.name}
    
    tokens = Tr8n::TransformToken.parse("{user.name} updated {user:gender|his,her} profile")
    assert_equal ["{user:gender|his,her}"], tokens.collect{|t| t.full_name}
    assert_equal ["{user}"], tokens.collect{|t| t.sanitized_name}
    assert_equal ["user"], tokens.collect{|t| t.name}
    
    tokens = Tr8n::TransformToken.parse("{user.name} updated {count:number|message} profile")
    ...
    tokens = Tr8n::TransformToken.parse("{user.name} updated {count||message} profile")
  ...
  test "decoration tokens" do
    tokens = Tr8n::DecorationToken.parse("You have [link1: {count} {count:number | new message, new messages}] in [link2: your inbox]")
  ...
  test "mixed tokens" do
    ...
    assert_equal ["Tr8n::DataToken",
                  "Tr8n::MethodToken",
                  "Tr8n::TransformToken", 
                  "Tr8n::TransformToken"], tokens.collect{|t| t.class.name}
    ...
    assert_equal ["Tr8n::DecorationToken",
                  "Tr8n::DecorationToken"], tokens.collect{|t| t.class.name}
  end
