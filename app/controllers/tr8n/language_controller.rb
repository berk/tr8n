class Tr8n::LanguageController < Tr8n::BaseController
  ...
  def select
    ...
    @enable_inline_translations = false
    
    if not tr8n_current_user_is_translator?
      @translations_allowed = true
    elsif tr8n_current_user_is_translator? and not tr8n_current_translator.blocked?
      @translations_allowed = true
      @enable_inline_translations = tr8n_current_translator.enable_inline_translations?
    end
