...
and then read the specification document, which will guide you on how to integrate Tr8n into your application.

To run Tr8n in a stand alone mode, run the following commandsa:

  $ cd vendor/plugins/tr8n
  $ rake db:migrate
  $ rake tr8n:init
  $ script/server
