...
The translations engine works by creating a hash value from the text and description of a phrase. That means that even a slight 
change to the original text or description will cause your string to be counted as a completely new one. So make sure you start 
off with a complete description you won't have to clarify later.
